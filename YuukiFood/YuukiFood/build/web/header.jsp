    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <a href="HomePage" class="logo d-flex align-items-center me-auto me-xl-0">
            ...
            <%--         <c:if test="${sessionScope.roleID == 1}">
                         <a href="userHomePage.jsp"><h1 class="sitename">Yummy<span style="color: red">.</span></h1><a/>
                         </c:if>
                         <c:if test="${sessionScope.roleID == 2}">
                             <a href="adminHome.jsp"><h1 class="sitename">Yummy<span style="color: red">.</span></h1><a/>
                             </c:if>
                             <c:if test="${sessionScope.roleID == 3}">
                                 <a href="staffHome.jsp"><h1 class="sitename">Yummy<span style="color: red">.</span></h1><a/>
                                 </c:if>
            --%>
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li><a href="ViewOrdered">Ordered</a></li>
                <c:if test="${sessionScope.account.roles.roleId == 2 || sessionScope.account.roles.roleId == 3}">
