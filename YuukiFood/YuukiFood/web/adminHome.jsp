...
<%@include file="CheckAdminRole.jsp" %>
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="AdminHomePage" class="logo d-flex align-items-center me-auto me-xl-0">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="ViewContact">Contact</a></li>
                ...
                <a href="Dashboard" >Manager Page</a>
...
<c:if test="${sessionScope['account']!=null}">
                    <li ><a href="Logout" style="color: black; list-style: none" class="login-link" ><i class="fa fa-sign-out" style="font-size: 18px; margin-left: 10px;" aria-hidden="true"> </i> </a></li>
                    </c:if>
    </div>
  </header>
